...
| R9 | Architecture | Vendor Wi-Fi or radio components require FreeRTOS scheduling | High | Critical | Kernel owner | ESP-IDF Wi-Fi adapter on ESP32-C5 uses FreeRTOS tasks, queues and event groups | ADR 0004: Stage 2 workflow excludes Wi-Fi. R9 is closed as a Stage 2 blocker and remains open for any later radio increment |
