...
|---|---|---|---|---|
| FreeRTOS | Embedded scheduler, tasks, queues, timers and synchronization | Current kernel substrate; Cirvane does not replace it | Any future kernel must outperform at matched scope | https://www.freertos.org/Documentation/00-Overview |
...
| Tock | Rust embedded OS with process isolation and capsules | Close capability/isolation research surface | A future Cirvane kernel must distinguish its recovery semantics | https://www.tockos.org/ |
