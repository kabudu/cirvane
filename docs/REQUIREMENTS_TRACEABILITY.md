...
| SEC-03 | Authenticated OTA transport | OTA adapter and policy | Canonical-manifest policy tests, signed-manifest tests, production build and adversarial real-board E2E | `cirvane-remote-ota-qualification.json`; exact-release evidence required before promotion | Transport qualified; release-artifact gate pending |
| REL-02 | Explicit developer-release limitations | Release owner | Claim/deferred-state scan | `.github/release-notes/v0.1.0.md` | Prepared; publication pending |
